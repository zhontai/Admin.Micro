...
namespace ZhonTai.Api.Doc
{
    public class ApiUIMiddleware
    {
        private const string _embeddedFileNamespace = "ZhonTai.Api.Doc.src.dist";
            ...
            ApiUIOptions options)
        {
            ...
            _staticFileMiddleware = ApiUIMiddleware.CreateStaticFileMiddleware(next, hostingEnv, loggerFactory, options);
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            if (httpMethod == "GET" && Regex.IsMatch(path, $"^/?{Regex.Escape(_options.RoutePrefix)}/?$", RegexOptions.IgnoreCase))
            {
                ...
                ApiUIMiddleware.RespondWithRedirect(httpContext.Response, relativeIndexUrl);
                return;
            }
            ...
            ApiUIOptions options)
        {
            var staticFileOptions = new StaticFileOptions
            {
                ...
                FileProvider = new EmbeddedFileProvider(typeof(ApiUIMiddleware).GetTypeInfo().Assembly, _embeddedFileNamespace),
            };
