...
using ZhonTai.Api.DynamicApi.Enums;
...
public class DynamicApiConvention : IApplicationModelConvention
{
    ...
    private static void ConfigureArea(ControllerModel controller, DynamicApiAttribute attr)
    {
        if (!controller.RouteValues.ContainsKey("area"))
        {
            if (attr == null)
            {
                throw new ArgumentException(null, nameof(attr));
            }
    ...
    private static void ConfigureFormatResult(ControllerModel controller)
    {
    ...
    /// <returns></returns>
    private static bool CheckNoMapMethod(ActionModel action)
    {
        bool isExist = false;
    ...
    /// <param name="action"></param>
    /// <returns></returns>
    private static bool CheckNoFormatResultMethod(ActionModel action)
    {
        bool isExist = false;
